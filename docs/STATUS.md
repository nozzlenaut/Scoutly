...
| Group | Category | Status | Catalog | Notes |
| --- | --- | --- | ---: | --- |
...
| Collectibles | LEGO | Lab | 318 | Exact set-number prototype; empty is preferred to partial-item junk. |

## Status meanings

- **Active:** ready for normal testing/use.
- **Lab:** useful, but still collecting false-positive reports.
- **Paused:** retained in the catalog but unavailable in the public search selector.
