...
- Current build: v0.6.20 polished KEH lens finder preview
- Next milestone: Continue private lens testing across mounts, brands, and model revisions before deciding on a public Sony E-mount pilot
