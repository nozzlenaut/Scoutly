...
PRODUCTION_ENV_VARS = (
    ...
    "SCOUTLY_ADMIN_TOKEN",
    "BUFFER_API_KEY",
    "BUFFER_BLUESKY_CHANNEL_ID",
    "BUFFER_DRAFT_DRY_RUN",
    "PUBLIC_API_BASE_URL",
    "OPENAI_API_KEY",
    "AI_CONSOLE_REVIEW_MODEL",
    "AI_CONSOLE_REVIEW_RESPONSES_URL",
    "AI_CONSOLE_REVIEW_TIMEOUT_SECONDS",
    "AI_CONSOLE_REVIEW_MAX_PER_MINUTE",
    "AI_CONSOLE_REVIEW_MAX_PER_DAY",
)
