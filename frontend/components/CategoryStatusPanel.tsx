  ...
  return (
    <section className="w-full rounded-3xl border border-white/10 bg-white/[0.04] p-4 text-left backdrop-blur">
      <div className="flex flex-col gap-3 sm:flex-row sm:items-center sm:justify-between">
        <div>
          <p className="text-xs uppercase tracking-[0.22em] text-slate-500">Category status</p>
          <p className="mt-1 text-sm text-slate-300">
            Cameras and GPUs are the cleanest right now. Consoles are in active testing. LEGO is a lab set-number prototype. Lenses are paused until results are clean enough to trust.
          </p>
        </div>
