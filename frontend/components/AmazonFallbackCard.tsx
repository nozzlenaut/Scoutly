...
export function AmazonFallbackCard({
  ...
  return (
    <>
      ...
      <section
        className={`mt-8 rounded-3xl border p-5 sm:p-6 ${theme === "light" ? "border-ps-border bg-ps-surface" : emphasized
      ...
      >
        <div className="flex flex-col justify-between gap-4 sm:flex-row sm:items-start">
          <div className="max-w-3xl">
            <p className={theme === "light" ? "text-xs font-bold uppercase tracking-[0.2em] text-ps-warning" : "text-xs font-bold uppercase tracking-[0.2em] text-orange-200"}>
          ...
          <span className={theme === "light" ? "w-fit rounded-full border border-ps-border bg-ps-control px-3 py-1 text-xs font-semibold text-ps-warning" : "w-fit rounded-full border border-orange-200/20 bg-orange-200/10 px-3 py-1 text-xs font-semibold text-orange-100"}>
        ...
        <div className="mt-5 flex flex-wrap gap-3">
          {exactUrl ? (
            <a
              ...
              className={theme === "light" ? "rounded-2xl bg-ps-accent-strong px-5 py-3 text-sm font-bold text-white transition hover:bg-ps-accent-hover" : "rounded-2xl bg-orange-200 px-5 py-3 text-sm font-bold text-slate-950 transition hover:bg-orange-100"}
            >
