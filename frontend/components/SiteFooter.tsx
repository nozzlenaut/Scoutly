    ...
    <footer className="mx-auto mt-12 max-w-5xl border-t border-white/10 px-2 py-6 text-sm text-slate-500">
      <div className="flex flex-col gap-3 sm:flex-row sm:items-center sm:justify-between">
        ...
        <div className="flex flex-wrap gap-x-4 gap-y-2">
          ...
          <Link href="/used" className="text-cyan-200 hover:text-cyan-100">Used price guides</Link>
          <Link href="/reuse" className="text-emerald-200 hover:text-emerald-100">Why buy used?</Link>
